...
class MyTv {
    ...
    void volumeUp() {
        // volume의 값이 MAX_VOLUME보다 작을 때만 값을 1 증가시킨다. MAX_VOLUME 이면 증가 안되게 만들기

    }
    void volumeDown() {
        // volume의 값이 MIN_VOLUME보다 클 때만 값을 1 감소시킨다. MIN_VOLUME 0보다 작은 -1이 될수 없게 만들기

    }
    void channelUp() {
        // channel의 값을 1 증가시킨다.  100이 넘으면 다시 1값으로 돌아가게 한다.
        // channel이 MAX_CHANNEL이면, channel의 값을 MIN_CHANNEL 바꾼다.

    }
    void channelDown() {
        // channel의 값을 1 감소시킨다. 1이 넘으면 다시 100값으로 돌아가게 한다.

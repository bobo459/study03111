    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<treeSetSize; i++) {
            System.out.print(treeSet.pollFirst() + " "); // 2 4 6 8 10 12 14 ... 50
                                                         //pollFirst : 가장왼쪽부터 꺼낸다 그래서 나중에 는 남은게 없어서 0값이 나온다
        }
        System.out.println();
        ...
        //#9. SortedSet<E> headSet(E element) // SortedSet 부모의 형태라 올 수 있다.
        ...
        //#10. NavigableSet<E> headSet(E element, boolean inclusive)   //inclusive:포함여부를 물어보는것 //headSet:본인을 포함 안함
        ...
        //#12. NavigableSet<E> tailSet(E element, boolean inclusive)  //tailSet:본인을 포함 함
        ...
        //#14. NavigableSet<E> subSet(E element, boolean inclusive, E element, boolean inclusive) //10부터 시작인데 10을 포함할건지 물어보는 식이다.
                                                                                                  // 비즈니스레벨에서 많이 사용한다.
        ...
        descendingSet=descendingSet.descendingSet(); // 반전을 다시 반전하면 원래대로 돌아온다.

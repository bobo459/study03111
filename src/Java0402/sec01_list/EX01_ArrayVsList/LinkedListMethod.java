package Java0402.sec01_list.EX01_ArrayVsList;
...
public class LinkedListMethod {
    public static void main(String[] args) {
        ...
        List<Integer> linkedlist1 = new LinkedList<Integer>();  //뭘사용하든 상관없지만, 만들고 생성, 삭제가 빠르다. 다른데이터가 변경할 필요가 없다.
        //하나하나 따라 가야지만 아이템을 찾을수 있다.
